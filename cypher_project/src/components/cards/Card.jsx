...
<svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg" style={{'color': 'rgb(56, 75, 181)','margin':'0 5px -3px 5px'}}><path d="M1 12C1 5.925 5.925 1 12 1s11 4.925 11 11-4.925 11-11 11S1 18.075 1 12Zm16.28-2.72a.751.751 0 0 0-.018-1.042.751.751 0 0 0-1.042-.018l-5.97 5.97-2.47-2.47a.751.751 0 0 0-1.042.018.751.751 0 0 0-.018 1.042l3 3a.75.75 0 0 0 1.06 0Z"></path></svg>
  ...
  return (
    ...
    <div className="btn-display">
      ...
      <div className={theme?"display-wrap-dk":"display-wrap-lt"} onClick={toggleOptions}>
      <div>    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" className="icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M3.5 2h-1v5h1V2zm6.1 5H6.4L6 6.45v-1L6.4 5h3.2l.4.5v1l-.4.5zm-5 3H1.4L1 9.5v-1l.4-.5h3.2l.4.5v1l-.4.5zm3.9-8h-1v2h1V2zm-1 6h1v6h-1V8zm-4 3h-1v3h1v-3zm7.9 0h3.19l.4-.5v-.95l-.4-.5H11.4l-.4.5v.95l.4.5zm2.1-9h-1v6h1V2zm-1 10h1v2h-1v-2z"></path></svg></div>
      Display
      <div ><svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z"></path></svg></div>
      </div>

      {showOptions && (
        <div className={theme?"sub-group-item-dk":"sub-group-item-lt"}>
          <div className={theme?"drop-item-group-dk":"drop-item-group-lt"}>
            <span>Grouping</span>
          ...
          <div className={theme?"drop-item-order-dk":"drop-item-order-lt"}>
            <span>Ordering</span>
      ...
      {theme?
        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg" style={{'color':'white'}}><path fill="none" d="M0 0h24v24H0z"></path><path d="M12 7c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zM2 13h2c.55 0 1-.45 1-1s-.45-1-1-1H2c-.55 0-1 .45-1 1s.45 1 1 1zm18 0h2c.55 0 1-.45 1-1s-.45-1-1-1h-2c-.55 0-1 .45-1 1s.45 1 1 1zM11 2v2c0 .55.45 1 1 1s1-.45 1-1V2c0-.55-.45-1-1-1s-1 .45-1 1zm0 18v2c0 .55.45 1 1 1s1-.45 1-1v-2c0-.55-.45-1-1-1s-1 .45-1 1zM5.99 4.58a.996.996 0 00-1.41 0 .996.996 0 000 1.41l1.06 1.06c.39.39 1.03.39 1.41 0s.39-1.03 0-1.41L5.99 4.58zm12.37 12.37a.996.996 0 00-1.41 0 .996.996 0 000 1.41l1.06 1.06c.39.39 1.03.39 1.41 0a.996.996 0 000-1.41l-1.06-1.06zm1.06-10.96a.996.996 0 000-1.41.996.996 0 00-1.41 0l-1.06 1.06c-.39.39-.39 1.03 0 1.41s1.03.39 1.41 0l1.06-1.06zM7.05 18.36a.996.996 0 000-1.41.996.996 0 00-1.41 0l-1.06 1.06c-.39.39-.39 1.03 0 1.41s1.03.39 1.41 0l1.06-1.06z"></path></svg>
      :
        ...
        {groupingOption === 'user' &&
          data.users.map((user) => (
            ...
            <div >
              ...
              <span className={theme?"st-title-dk":"st-title-lt"}>{user.name}</span> <span className="cnt">{displayedTickets[user.id] ? displayedTickets[user.id].length : 0} </span>
              </div>
        ...
        {groupingOption === 'priority' &&
          [0, 1, 2, 3, 4].map((priority) => (
            ...
            {getPriorityIcon(priority)}
              ...
              <span className={theme?"st-title-dk":"st-title-lt"}>{priorityLabels[priority]}</span> <span className="cnt">{displayedTickets[priority] ? displayedTickets[priority].length : 0} </span> 
              </div>
              <div className="hd-icons">
                 <div className="icon-wrap">
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg" style={{'color':'gray','marginRight':'5px'}}><path fill="none" d="M0 0h24v24H0z"></path><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path></svg>
        ...
        {groupingOption === 'status' &&
          ['Backlog', 'Todo', 'In progress', 'Done', 'Cancelled'].map((status) => (
            ...
            {getStatusIcon(status)}
              ...
              <span className={theme?"st-title-dk":"st-title-lt"}>{status}</span> <span className="cnt">{displayedTickets[status] ? displayedTickets[status].length : 0} </span> 
              </div>
              <div className="hd-icons">
                 <div className="icon-wrap">
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg" style={{'color':'gray','marginRight':'5px'}}><path fill="none" d="M0 0h24v24H0z"></path><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path></svg>
